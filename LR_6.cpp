...
int main() {
    ...
    while (com != 'n') { //цикл меню
        ...
        for (int x = 0; x < Nstroki; x++) { //перебор с 0 до количества строк (используем другой индекс)
            matrix[x] = new double[Mstolbci]; //добавление массива столбцов в каждый элемент строчки
            NewMatrix[x] = new double[Mstolbci]; //добавление массива столбцов в каждый элемент строчки
            for (int y = 0; y < Mstolbci; y++) { //перебор с 0 до количества столбцов (используем другой индекс)
        ...
        for (int x = 0; x < Nstroki; x++) { //очистка памяти в строках матриц
            delete[] matrix[x]; //очистка памяти в строках исходной матрицы
            delete[] NewMatrix[x]; //очистка памяти в строках измененной матрицы
        }
